// iBus2PWM version 1.00
// Arduino Nano/Pro code to read FlySky iBus and output
// x channels of CPPM and 2 PWM (3 and 11 pin)
//Forked from povlhp/iBus2PPM
...
#define FAILSAFELIMIT 990    // When all the 6 channels below this value assume failsafe
...
#endif          
          sei();
          PWMVal1 = ((int(rcValue[7])-1000)/10)+125+30*(int(rcValue[7])-1000)/1000;
          PWMVal2 = ((int(rcValue[8])-1000)/10)+125+30*(int(rcValue[8])-1000)/1000;
